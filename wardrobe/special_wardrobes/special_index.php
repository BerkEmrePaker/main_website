...
<body>
    ...
    <?php wardrobe_navbar();  ?>
    <br><br><br><br>
    <h2 style="width: 100%; text-align: center; color: white;">Choose Table To VIEW</h2>
    <div class="mainframe">
        <div class="links">
            <form action="special_display.php" method="post">
            <?php
            foreach ($tableNames as $tableName) 
            {
                echo '<input type="submit" name="table_choice" value="' . htmlspecialchars($tableName) . '"><br><br>';
            } ?>
            </form>
            <h2 style="text-align: center;"><a style="color: #46e871;" href="create_table.php">Create New Table</a>   &nbsp&nbsp&nbsp   <a style="color: red;" href="create_table.php">Delete a Table</a></h2>
        </div>
